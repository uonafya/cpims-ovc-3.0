...
class SetupList(models.Model):
    ...
    item_id = models.CharField(max_length=447)
    item_description = models.CharField(max_length=1255)
    item_description_short = models.CharField(max_length=1100, null=True)
    item_category = models.CharField(max_length=1255, null=True, blank=True)
    item_sub_category = models.CharField(max_length=1255, null=True, blank=True)
    ...
    is_void = models.BooleanField(default=False)
    field_name = models.CharField(max_length=1200, null=True, blank=True)
    timestamp_updated = models.DateTimeField(auto_now=True, null=True)
