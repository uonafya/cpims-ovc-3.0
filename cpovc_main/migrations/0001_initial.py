    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beneficiary_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='encounter_beneficiary', to='cpovc_registry.regperson')),
                ('workforce_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='encounter_workforce', to='cpovc_registry.regperson')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp_created', models.DateTimeField(null=True)),
                ('timestamp_updated', models.DateTimeField(auto_now=True, null=True)),
                ('beneficiary_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='service_beneficiary', to='cpovc_registry.regperson')),
                ('workforce_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='service_workforce', to='cpovc_registry.regperson')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beneficiary_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='encounter_n_beneficiary', to='cpovc_registry.regperson')),
                ('encounter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cpovc_main.coreencounters')),
                ('workforce_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='encounter_n_workforce', to='cpovc_registry.regperson')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sms_id', models.IntegerField(null=True)),
                ('form_id', models.IntegerField(null=True)),
                ('beneficiary_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='adverse_beneficiary', to='cpovc_registry.regperson')),
            ],
            options={
