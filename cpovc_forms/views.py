...
from cpovc_forms.forms import (
    ...
    CaseClosureForm, PREVENTIVE_ATTENDANCE_REGISTER_FORM)
...
from .models import (
    ...
    OVCCareTransfer, OVCHEITracker, OVCPreventiveEvents, PMTCTQuestions, PMTCTHEI, PMTCTEvents, OVCCareCaseExit,OVCPreventiveEvents)
    ...
    if request.method == 'GET':
        ...
        if delta < 90:
            if btn_event_type == 'EBI':
                ...
                preventive_reg_services = OVCPreventiveService.objects.filter(event=event_obj)
                service_type_list = []
                olmis_assessment_domain_list = get_list(
                    'attendance_reg_domains', 'Please Select')
                date_of_event_edit = event_obj.date_of_event
    ...
    if request.method == 'POST':
        ...
        if args_value == 1:
            ...
            if olmis_assessment_provided_list:
                ...
                olmis_intervention_prevention = olmis_assessment_data.get("olmis_intervention_prevention")
                completed_all_session = olmis_assessment_data.get('holmis_completed_all_sessions')
                session_attended = olmis_assessment_data.get('olmis_session_attended_days')
                ...
                if session_date:
                    ...
                    try:
                        ...
                        OVCPreventiveEbi.objects.filter(event=primary_key).update(
                            domain = olmis_intervention_prevention, 
                            ebi_provided =  "",
                            ebi_session = session_attended,#'Session 1,2,3...',
                            ebi_session_type = ebi_session_type,
        ...
        msg = 'Save Successful'
        return jsonResponse.append({'msg': msg})
