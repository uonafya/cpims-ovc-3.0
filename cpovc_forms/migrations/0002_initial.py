...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='caregiver',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cpara_caregiver_upgrade', to='cpovc_registry.regperson'),
        ),
        migrations.AddField(
            model_name='ovccarecpara_upgrade',
            name='event',
        ...
        migrations.AddField(
            model_name='ovcbenchmarkmonitoring',
            name='person',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cpovc_ovc.ovcregistration'),
        ),
        migrations.AddField(
