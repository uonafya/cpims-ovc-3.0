...
class OVCHIVManagement(models.Model):
    ...
    current_regimen = models.CharField(max_length=20, null=True)
    enough_drugs = models.CharField(max_length=20, null=True)
    plan_track_unstable = models.CharField(max_length=20, null=True)
    otz = models.CharField(max_length=20, null=True)
...
class pmtct_registration(models.Model):
    ...
    caretaker = models.ForeignKey(RegPerson, null=True, related_name='c_taker', on_delete=models.CASCADE)
...
class OVCCareCaseClosureExit(models.Model):
...
class OVCCareCaseExit(models.Model):
    case_clouse_id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    person = models.ForeignKey(RegPerson, on_delete=models.CASCADE,related_name='caseclouse_child')
    caregiver = models.ForeignKey(RegPerson, on_delete=models.CASCADE, related_name='exit_caregiver')
    organization = models.ForeignKey(RegOrgUnit, on_delete=models.CASCADE)
    rec_organization = models.CharField(max_length=250, null=True)
    attrition_reason = models.CharField(max_length=10, null=True)
