...
class OVCHEITracker(models.Model):
    ...
    f2hivtest = models.CharField(max_length=20, null=True)
    f2testresults = models.CharField(max_length=20, null=True)
    f2vlresults = models.CharField(max_length=20, null=True)
    f2prophylaxis = models.CharField(max_length=20, null=True)
    f2immunization = models.CharField(max_length=20, null=True)
    f2mode = models.CharField(max_length=20, null=True)
    f3hivtest = models.CharField(max_length=20, null=True)
    f3testresults = models.CharField(max_length=20, null=True)
    f3vlresults = models.CharField(max_length=20, null=True)
    f3prophylaxis = models.CharField(max_length=20, null=True)
    f3immunization = models.CharField(max_length=20, null=True)
    f3mode = models.CharField(max_length=20, null=True)
    f4hivtest = models.CharField(max_length=20, null=True)
    f4testresults = models.CharField(max_length=20, null=True)
    f4vlresults = models.CharField(max_length=20, null=True)
    f4prophylaxis = models.CharField(max_length=20, null=True)
    f4immunization = models.CharField(max_length=20, null=True)
    f4mode = models.CharField(max_length=20, null=True)
    f5hivtest = models.CharField(max_length=20, null=True)
    f5testresults = models.CharField(max_length=20, null=True)
    f5vlresults = models.CharField(max_length=20, null=True)
    f5prophylaxis = models.CharField(max_length=20, null=True)
    f5immunization = models.CharField(max_length=20, null=True)
    f5mode = models.CharField(max_length=20, null=True)
