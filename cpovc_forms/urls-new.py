...
# This should contain paths related to Forms ONLY
urlpatterns = [
    # Forms Registry
    ...
    # Management paths
    path(
        'manage_refferal/', views.manage_refferal,
        name='manage_refferal'),
    path(
        'manage_refferal001/', views.manage_refferal001,
        name='manage_refferal001'),
    path(
        'manage_refferal002/', views.manage_refferal002,
        name='manage_refferal002'),
    path(
        'manage_refferal003/', views.manage_refferal003,
        name='manage_refferal003'),
    path(
        'manage_casecategory001/', views.manage_casecategory001,
        name='manage_casecategory001'),
    path(
        'manage_casecategory002/', views.manage_casecategory002,
        name='manage_casecategory002'),
    path(
        'manage_casecategory003/', views.manage_casecategory003,
        name='manage_casecategory003'),
    path(
        'manage_casecategory004/', views.manage_casecategory004,
        name='manage_casecategory004'),
    path(
        'manage_encounters001/', views.manage_encounters001,
        name='manage_encounters001'),
    path(
        'manage_encounters004/', views.manage_encounters004,
        name='manage_encounters004'),
    path(
        'manage_case_events/', views.manage_case_events,
        name='manage_case_events'),
    path(
        'manage_placementfollowup/', views.manage_placementfollowup,
    ...
    path(
        'manage_casehistory/', views.manage_casehistory,
        name='manage_casehistory'),
    path(
        'manage_service_category/', views.manage_service_category,
        name='manage_service_category'),
    path(
        'manage_form_type/', views.manage_form_type,
        name='manage_form_type'),
    path(
        'userorgunits_lookup/', views.userorgunits_lookup,
        name='userorgunits_lookup'),
    path(
        'usersubcounty_lookup/', views.usersubcounty_lookup,
        name='usersubcounty_lookup'),
    path(
        'userward_lookup/', views.userward_lookup, name='userward_lookup'),
    path(
        'generate_serialnumber/', views.generate_serialnumber,
        name='generate_serialnumber'),
    path(
        'getJsonObject001/', views.getJsonObject001, name='getJsonObject001'),
    ...
    path(
        'education/new/<int:id>/', views.new_education_info,
    ...
    path(
        'bursary/delete/', views.delete_bursary_info,
        name='delete_bursary_info'),
    path(
        'bursary/followup/<int:id>/', views.bursary_followup,
    ...
    re_path('form1a/edit/<int:id>/(?P<btn_event_type>\w+)/(?P<btn_event_pk>\w+)/', views.edit_form1a,
            name='edit_form1a'),
    path('form1a/view/', views.view_form1a, name='view_form1a'),
    re_path('form1a/delete/<int:id>/(?P<btn_event_type>\w+)/(?P<btn_event_pk>.+)/', views.delete_form1a,
            name='delete_form1a'),
    ...
    path(
        'form1a/manage/', views.manage_form1a_events,
        name='manage_form1a_events'),

    # OVC Care - Form1B
    path('form1b/new/<int:id>/', views.new_form1b, name='new_form1b'),
    path(
        'form1b/delete/<int:id>/<uuid:btn_event_pk>',
        views.delete_form1b, name='delete_form1b'),
    path(
        'form1b/manage/', views.manage_form1b_events,
    ...
    path('bursary/list/<int:id>/', views.list_bursary, name='list_bursary'),
    path(r'^bursary/view/<uuid:id>/', views.view_bursary, name='view_bursary'),
    path('bursary/new/<int:id>/', views.new_bursary, name='new_bursary'),
    path(r'^bursary/edit/<uuid:id>/', views.edit_bursary, name='edit_bursary'),
    path(r'^bursary/form/<uuid:id>/', views.form_bursary, name='form_bursary'),

    # OVC Care - CPARA Form
    path('cpara/new/<int:id>/', views.new_cpara, name='new_cpara'),
    path(
        'cpara/delete/<int:id>/<uuid:btn_event_pk>/', views.delete_cpara,
        name='delete_cpara'),
    ...
    path(
        ...
        name='new_caseplan'),
    path(
        'caseplan/update/<int:ovcid>/<uuid:event_id>/', views.update_caseplan,
        name='update_caseplan'),
    path(
        'caseplan-monitoring/new/<int:id>/', views.new_case_plan_monitoring,
        name='new_caseplan_monitoring'),
