...
NB the categories are not mutually exclusive. If the OVC don't fall in any of the categories above, include under ineligible
'''
CHART['2I']['calc'] = '''
...
CHART['5B'] = {}
CHART['5B']['desc'] = '''
Number of households with CPARA assessment in the last 12 months relative 
...
CHART['5C'] = {}
CHART['5C']['desc'] = '''
Number of HH categorized by graduation pathways based on CPARA (Highly Vulnerable, Low Vulnerability, 
...
CHART['7D'] = {}
CHART['7D']['desc'] = '''
Percentage of orphans and vulnerable children (<18 years old) enrolled in the OVC
