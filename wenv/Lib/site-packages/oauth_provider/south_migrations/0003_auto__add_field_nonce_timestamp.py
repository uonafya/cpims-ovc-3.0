...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Nonce.timestamp'
        db.add_column(u'oauth_provider_nonce', 'timestamp',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1375699511, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Nonce.timestamp'
        db.delete_column(u'oauth_provider_nonce', 'timestamp')
    ...
    models = {
        ...
        u'oauth_provider.token': {
            ...
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1375699483L'}),
