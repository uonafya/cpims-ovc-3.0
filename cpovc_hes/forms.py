...
SECTOR=(('Agriculture','Agriculture'),(' Non Agriculture','Non Agriculture'))

FINANCIAL_INSTITUTION_TYPE=( ('Bank ','Bank'),(' MFI','MFI'),(' SACCO','SACCO'),(' VSLA','VSLA'))
TYPE_OF_ASSETS=( ('Business Asset','Business Asset'),('Agriculture assets ','Agriculture assets '))
