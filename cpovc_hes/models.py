...
class CPOVC_HES(models.Model):
    ...
    monthly_saving_average = models.DecimalField(max_digits=10,decimal_places=2,blank=True,null=True)
    average_cumulative_saving = models.DecimalField(max_digits=10,decimal_places=2, blank=True,null=True)
    loan_taken = models.CharField( max_length=50,blank=True,null=True)
    loan_taken_amount = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    ...
    amount_received_ect = models.DecimalField( max_digits=10, decimal_places=2, blank=True, null=True)
    ...
    average_monthly_income_generated = models.DecimalField( max_digits=10,decimal_places=2,blank=True,null=True)
    received_business_grant = models.CharField(max_length=50,blank=True,null=True)
    amount_of_money_received = models.DecimalField(max_digits=10,decimal_places=2,blank=True,null=True)
