...
cpims_db_pass = os.environ.get(
    'CPIMS_PASSWORD') if os.environ.get('CPIMS_PASSWORD') else 'admin@123'
cpims_db_instance = os.environ.get(

    'CPIMS_DB') if os.environ.get('CPIMS_DB') else 'cpims_db'

cpims_db_port = os.environ.get(
    'CPIMS_PORT') if os.environ.get('CPIMS_PORT') else '5432'
cpims_db_user = os.environ.get(
    'CPIMS_DBUSER') if os.environ.get('CPIMS_DBUSER') else 'cpims_dmin'
