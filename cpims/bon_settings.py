...
SECRET_KEY = 'h34yo5l8c8!edb%^b@3j-i^fdwqgc$e)fcjnw_9jm4a^%jbq&*41+@'
...
cpims_db_host = os.environ.get(
    'CPIMS_HOST') if os.environ.get('CPIMS_HOST') else ''
cpims_db_pass = os.environ.get(
    'CPIMS_PASSWORD') if os.environ.get('CPIMS_PASSWORD') else '123456@Ab'
cpims_db_instance = os.environ.get(
    'CPIMS_DB') if os.environ.get('CPIMS_DB') else 'cpims_main'
cpims_db_port = os.environ.get(
    'CPIMS_PORT') if os.environ.get('CPIMS_PORT') else '5432'
cpims_db_user = os.environ.get(
    'CPIMS_DBUSER') if os.environ.get('CPIMS_DBUSER') else 'admin'
