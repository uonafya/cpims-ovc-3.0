...
cpims_db_port = os.environ.get(
    'CPIMS_PORT') if os.environ.get('CPIMS_PORT') else '5435'
...
NASCOP_API_BASE_URL = os.environ.get(
    'NASCOP_API_BASE_URL') if os.environ.get('NASCOP_API_BASE_URL') else 'https://api.nascop.org/vl/ver2.0/patient/results/'
NASCOP_LOGIN_URL = os.environ.get(
    'NASCOP_LOGIN_URL') if os.environ.get('NASCOP_LOGIN_URL') else 'https://api.nascop.org/auth/ver2.0/login'
NASCOP_EMAIL = os.environ.get(
    'NASCOP_EMAIL') if os.environ.get('NASCOP_EMAIL') else 'rpundo@healthit.uonbi.ac.ke'
NASCOP_PASSWORD = os.environ.get(
    'NASCOP_PASSWORD') if os.environ.get('NASCOP_PASSWORD') else 'UUwF3AlPaZ7z0uynDT'
