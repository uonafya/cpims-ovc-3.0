    ...
    if request.method == 'POST':
        ...
        try:
            ...
            try:
                ...
                benchmark_data = OVCBenchmarkMonitoring.objects.filter(is_void=False, household=house_hold, event_date__range=[today_less90, to])   #filter(event=event).order_by('event_date'))
            except Exception as e:
                benchmark_data = {}
                print(e)
