...
def sinovuyoteenPreAndPostAssesmnetRevisedFinalDraft(request, id):
    ...
    if request.method == 'POST':
        ...
        if data:
            ...
            # pdb.set_trace()
            messages.success(request, 'Form Saved Successfully! We are done! Thank you for sharing this information with us. We really value you
and appreciate you for taking part in this interview.')
        else:
            messages.error(request, 'Error saving form!')
