...
from .models import (
    ...
    OVCCareBenchmarkScore, OVCMonitoring, OVCHouseholdDemographics, OVCHivStatus, OVCHIVManagement, OVCHIVRiskScreening, SinovuyuTeenPreAndPostAssesment, OVCPrevSinovyoTeenEvaluation)
...
def sinovuyoteenPreAndPostAssesmnetRevisedFinalDraft(request, id):
    ...
    if request.method == 'POST':
        ...
        child = RegPerson.objects.get(id=id)
        # pdb.set_trace()
        assessment_tyepe = data['ASSESSMENT_TYPE']
