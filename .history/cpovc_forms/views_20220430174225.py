...
def edit_sinovuyoteenformrequest(request, id):
    ...
    form = SinovuyoteenPreAndPostAssesmnetRevisedFinalDraftForm(data=sinivuyo_teen_data)
    return render(request, 'forms/new_sinovuyoteen.html', {'sinovuyo_teen': form, 'fmpdata': sinivuyo_teen, 'status': 200})
