...
feeling_sad_id = get_list('feeling_sad_id')
my_behaviour_id = get_list('my_behaviour_id')
relationship_caregiver_id = get_list('relationship_caregiver_id')
father_mortality_id = get_list('father_mortality_id')
mother_mortality_id = get_list('dsp_times_id')
literacy_lvl_id = get_list('literacy_lvl_id')
# dsp_times_id = get_list('dsp_times_id')
