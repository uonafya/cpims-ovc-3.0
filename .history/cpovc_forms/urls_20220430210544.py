...
urlpatterns = [
    ...
    # edit_teen_sinavuyo 
    re_path('new_sinovuyoteen_form_edit/(?P<id>\d+)/update', views.edit_sinovuyoteenformrequest),
    # delete_teen_sinavuyo
    path('new_sinovuyoteen_form_delete/<id>/delete', views.delete_sinovuyoteenformrequest),
