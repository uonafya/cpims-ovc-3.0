    ...
    if request.method == 'POST':
        ...
        try:
            ...
            try:
                ...
                bm_lastlast_score_hh = hhcrpa_last.benchmark1+hhcrpa_last.benchmark2+hhcrpa_last.benchmark3+hhcrpa_last.benchmark4+hhcrpa_last.benchmark5+hhcrpa_last.benchmark6+hhcrpa_last.benchmark7+hhcrpa_last.benchmark8+hhcrpa_last.benchmark9
            ...
            print(f'{last_score_hh} , {hhrcpa} bm_lastscore {bm_last}')
