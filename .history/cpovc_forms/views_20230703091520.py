    ...
    if request.method == 'POST':
        ...
        try:
            ...
            try:
                ...
                benchmark_data = OVCBenchmarkMonitoring.objects.filter(is_void=False, household=house_hold, event_date__range=[today_less90, today], is_void=False).order_by('-event_date')
