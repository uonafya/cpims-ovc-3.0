...
class OVCF1AForm(forms.Form):
    ...
    olmis_assessment_coreservice = forms.ChoiceField(choices=olmis_assessment_domain_list,
                                                     initial='0',
                                                     widget=forms.Select(
        attrs={'class': 'form-control',
               'id': 'olmis_assessment_coreservice'})
    )
    olmis_assessment_coreservice_status = forms.ChoiceField(choices=olmis_assessment_coreservice_status,
                                                            initial='0',
                                                            widget=forms.SelectMultiple(
        attrs={'class': 'form-control',
