...
def edit_sinovuyoteenformrequest(request, id):
    ...
    if request.method == 'POST':
        ...
        messages.success(request, "Form Updated Successfully!  We are done! Thank you for sharing this information with us. We really value you and appreciate you for taking part in this interview.")
...
def delete_sinovuyoteenformrequest(request):
    ...
    return render(request, 'forms/new_sinovuyoteen.html', {'child': sinivuyo_teen, 'edit_flag': edit_flag, 'status': 200})
