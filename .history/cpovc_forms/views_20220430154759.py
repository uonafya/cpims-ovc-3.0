...
from .models import (
    ...
    OVCHIVManagement, OVCHIVRiskScreening, 
    SinovuyuTeenPreAndPostAssesment,
    OVCPreventiveEvents,
    OVCPrevSinovyoTeenEvaluation)
...
def sinovuyoteenPreAndPostAssesmnetRevisedFinalDraft(request, id):
    ...
    sinovuyoteenform = SinovuyoteenPreAndPostAssesmnetRevisedFinalDraftForm(request.POST) 
    ...
    if request.method == 'POST':
        ...
        child = RegPerson.objects.get(id=id)
        if data:       
            qry =OVCPrevSinovyoTeenEvaluation(
                    # evaluation_id = uuid.uuid1(),
                    person = child,
                    ref_caregiver = person,
                    bd_age = data['bd_age'],
                    bd_sex = data['bd_sex'],
                    bd_read = data['bd_read'],
                    bd_education_level = data['bd_education_level'],
                    bd_class = data['bd_class'],   
                    bd_bd_boarding_status = data['bd_bd_boarding_status'],
                    bd_biological_children = data['bd_biological_children'],
                    bd_live_bilogical_mother = data['bd_live_bilogical_mother'],
                    bd_live_biological_father = data['bd_live_biological_father'],
                    bd_disability = data['bd_disability'],   
                    bd_money_essentials = data['bd_money_essentials'],   
                    bd_violence = data['bd_violence'],   
                    bd_adult_unwell = data['bd_adult_unwell'],   
                    bd_child_unwell = data['bd_child_unwell'],   
                    bd_miss_school = data['bd_miss_school'],   
                    bd_hiv_status = data['bd_hiv_status'],   
                    bd_hiv_prevention = data['bd_hiv_prevention'],   
                    bd_two_meals = data['bd_two_meals'],   
                    bd_missing_meal = data['bd_missing_meal'],   
                    rc_discuss_child_needs = data['rc_discuss_child_needs'],
                    rc_discipline = data['rc_discipline'],   
                    rc_tells_bothering = data['rc_tells_bothering'],   
                    rc_involve_decisions = data['rc_involve_decisions'],   
                    cb_child_obedient = data['cb_child_obedient'],   
                    cb_figths_children = data['cb_figths_children'],   
                    dc_often_discipline = data['dc_often_discipline'],   
                    dc_physical_discipline = data['dc_physical_discipline'],   
                    dc_upset_child = data['dc_upset_child'],   
                    sp_physical_punish = data['sp_physical_punish'],   
                    fs_unhappy = data['fs_unhappy'],   
                    fs_too_tired = data['fs_too_tired'],   
                    fs_hopeful = data['fs_hopeful'] 
                ).save()
...
def edit_sinovuyoteenformrequest(request, id):
    try:
        ...
        if request.method == 'POST':
            ...
            OVCPrevSinovyoTeenEvaluation.objects.filter(evaluation_id=id).update(                   
                person = child,
                ref_caregiver = person,
                bd_age = data['bd_age'],
                bd_sex = data['bd_sex'],
        ...
        # sinivuyo_teen = OVCFMPEvaluation.objects.get(evaluation_id=id)
        fmp={ 
            ...
            'bd_live_biological_father' : sinivuyo_teen. 
            'bd_disability' : sinivuyo_teen. 
            'bd_money_essentials' : sinivuyo_teen. 
            'bd_violence' : sinivuyo_teen. 
            'bd_adult_unwell' : sinivuyo_teen. 
            'bd_child_unwell' : sinivuyo_teen. 
            'bd_miss_school' : sinivuyo_teen. 
            'bd_hiv_status' : sinivuyo_teen. 
            'bd_hiv_prevention' : sinivuyo_teen. 
            'bd_two_meals' : sinivuyo_teen. 
            'bd_missing_meal' : sinivuyo_teen. 
            'rc_discuss_child_needs' : sinivuyo_teen. 
            'rc_discipline' : sinivuyo_teen. 
            'rc_tells_bothering' : sinivuyo_teen. 
            'rc_involve_decisions' : sinivuyo_teen. 
            'cb_child_obedient' : sinivuyo_teen. 
            'cb_figths_children' : sinivuyo_teen. 
            'dc_often_discipline' : sinivuyo_teen. 
            'dc_physical_discipline' : sinivuyo_teen. 
            'dc_upset_child' : sinivuyo_teen. 
            'sp_physical_punish' : sinivuyo_teen. 
            'fs_unhappy' : sinivuyo_teen. 
            'fs_too_tired' : sinivuyo_teen. 
            'fs_hopeful' : sinivuyo_teen. 
            
            
            
            'FORMS_CHOICES': sinivuyo_teen.form_type,
            'WB_AD_PLC_7': sinivuyo_teen.caregiver_know_where,
            'WB_AD_PLC_8_1': sinivuyo_teen.caregiver_know_what,
            'WB_AD_PLC_9_1': sinivuyo_teen.caregiver_know_who,
            'WB_AD_TV_13_1': sinivuyo_teen.child_watch_often,
            'WB_AD_TV_13_2': sinivuyo_teen.what_program,
            'WB_AD_TV_13_3': sinivuyo_teen.specific_program,
            'WB_AD_TV_13_4': sinivuyo_teen.talk_on_topic,
            'WB_AD_TV_13_5': sinivuyo_teen.watch_with_child,
            'WB_AD_HE_15_1': sinivuyo_teen.talk_on_sex,
            'WB_AD_HE_15_2': sinivuyo_teen.talk_on_hiv,
            'WB_AD_HE_15_3': sinivuyo_teen.talk_on_sti,
            'WB_AD_HE_15_4': sinivuyo_teen.other_sexual_issues,
            'WB_AD_HE_15_4_1': sinivuyo_teen.if_yes,
            'WB_AD_HE_15_5': sinivuyo_teen.child_asks,
            'WB_AD_HE_15_6': sinivuyo_teen.if_asks,
            'WB_AD_HE_15_8': sinivuyo_teen.comfortable,
            'WB_AD_HE_15_9': sinivuyo_teen.how_talk,
            'WB_AD_HE_15_10': sinivuyo_teen.enough_information,
            'WB_AD_HE_15_11': sinivuyo_teen.talk_bad_things,
            'WB_AD_HE_15_12': sinivuyo_teen.ask_questions,
            'WB_AD_THO_16_1': sinivuyo_teen.thoughts_on_sex,
            'WB_AD_THO_16_2': sinivuyo_teen.ready_to_learn,
            'WB_AD_THO_16_3': sinivuyo_teen.still_young,
            'WB_AD_THO_16_4': sinivuyo_teen.have_someone,
            'WB_AD_THO_16_5': sinivuyo_teen.guardian_responsibility,
            'WB_AD_THO_16_6': sinivuyo_teen.happy_with_child
        }
