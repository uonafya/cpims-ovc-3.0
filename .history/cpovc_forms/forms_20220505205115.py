...
class OVCPreventivePrePostProgramAssessmentForm (forms.Form):
    CHOICES_TYPE_ASSESSMENT = get_list("programme_id", "Please select")
    ...
    CHOICES_INCOME = get_list("employed_id")
    CHOICES_RELATIONSHIP = get_list('relationship_caregiver_id')
    CHOICES_BEHAVIOR = get_list("my_behaviour_id")
    CHOICES_DISCIPLINE = get_list("dsp_times_id")
    CHOICES_BIOLOGICAL_FATHER = get_list("father_mortality_id")          
    CHOICES_BIOLOGICAL_MOTHER = get_list("mother_mortality_id")
    CHOICES_HIV = get_list("under_care_id")
    CHOICES_FEELING = get_list("agree_id")
    CHOICES_SAD = get_list("feeling_sad_id")
    CHOICES_FINANCE = get_list("often_id")
