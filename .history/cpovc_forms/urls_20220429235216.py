...
urlpatterns = [
    ...
    re_path('new_modelform_form/new/(?P<id>\d+)/', views.create_view, name='new_sinovu_form_model_form'),
    re_path('new_list_view_form/new/', views.create_view, name='new_sinovu_form_model_form'),
