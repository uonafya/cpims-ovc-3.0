...
SECTION_DISCIPLINE_FROM_MY_CAREGIVER = get_list('dsp_times_id','Please Select')
school_type_id = get_list('school_type_id','Please Select')
SECTION_FEELING_SAD = get_list('feeling_sad_id','Please Select')
SECTION_THREE_MY_BEHAVIOUR = get_list('my_behaviour_id','Please Select')
SECTION_TWO = get_list('relationship_caregiver_id', 'Please Select')
Father_Mortality_choices = get_list('father_mortality_id, 'Please Select'')
Mother_Mortality_choices = get_list('mother_mortality_id', 'Please Select')
CHOICES_READ = get_list('literacy_lvl_id', 'Please Select')
sp_physical_punish_choices = get_list('sp_physical_id', 'Please Select')
...
class SinovuyoteenPreAndPostAssesmnetRevisedFinalDraftForm(forms.ModelForm):
    ...
    class_defualt_choices = (("", 'Please Select'),)
