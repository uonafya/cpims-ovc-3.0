...
class SinovuyoteenPreAndPostAssesmnetRevisedFinalDraftForm(forms.ModelForm):
    CHOICES_READ = ((" ", 'Select'),(0, 'Cannot read at all'),
    ...
    SECTION_THREE_MY_BEHAVIOUR = ((" ", 'Select'),
    ...
    bd_age = forms.IntegerField(label='Enter Number', label_suffix=" : ", min_value=1, max_value=100, required=False,
    ...
    bd_bd_boarding_status = forms.ChoiceField(
        choices=((0,'Boarding '),(1,'Day school')),
        widget=forms.Select(
            attrs={
