...
class OVCFamilyCare(models.Model):
    ...
    fostered_from = models.ForeignKey(
        RegOrgUnit, on_delete=models.CASCADE, related_name='fostered_from_fk', null=True)
...
class OVCHIVRiskScreening(models.Model):
    ...
    parent_consent_date = models.DateTimeField(
...
class OVCBiReferral(models.Model):
    ...
    primary_key=True, default=uuid.uuid1, editable=False)
    person = models.ForeignKey(RegPerson)
    ref_caregiver = models.ForeignKey(
        RegPerson, on_delete=models.CASCADE, related_name='refferal_caregiver')
