    ...
    if request.method == 'POST':
        ...
        try:
            OVCBenchmarkMonitoring.objects.create(
                ...
                succesful_exit_checked =answer_value[data.get('cm13q')] if answer_value[data.get('cm13q')] else False,
                case_closure_checked=answer_value[data.get('cm14q')] if answer_value[data.get('cm14q')] else False,
                event_date=event_date,
                event=ovccareevent,
        ...
        try:
            ...
            try:
                ...
                last_score = hhcrpa_last.benchmark1+hhcrpa_last.benchmark2+hhcrpa_last.benchmark3+hhcrpa_last.benchmark4+hhcrpa_last.benchmark5+hhcrpa_last.benchmark6+hhcrpa_last.benchmark7+hhcrpa_last.benchmark8+hhcrpa_last.benchmark9
                # breakpoint()
            except Exception as e:
                benchmark_data = {}
                hhrcpa  = 0 
