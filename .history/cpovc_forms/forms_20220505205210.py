...
class OVCPreventivePrePostProgramAssessmentForm (forms.Form):
    CHOICES_TYPE_ASSESSMENT = get_list("programme_id", "Please select", "Please select")
    CHOICES_READ = get_list('literacy_lvl_id', "Please select")
    CHOICES_EDUCATION = get_list("school_level_id", "Please select")
    YES_NO_CHOICES = yesno_list = get_list('yesno_id', "Please select")
