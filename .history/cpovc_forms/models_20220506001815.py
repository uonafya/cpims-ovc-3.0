...
class OVCPreventiveEvents(models.Model):
    ...
    person = models.ForeignKey(RegPerson, on_delete=models.CASCADE,null=True)
    house_hold = models.ForeignKey(OVCHouseHold,default=1,on_delete=models.CASCADE, null=True)
...
class OVCPrevSinovyoTeenEvaluation(models.Model):
    evaluation_id = models.UUIDField(
        primary_key=True, default=uuid.uuid1, editable=False)
    person = models.ForeignKey(RegPerson, on_delete=models.CASCADE, blank=True)
    ...
    bd_class = models.CharField(max_length=100, default="Not_in_School")
    bd_bd_boarding_status = models.CharField(max_length=10, default="Not_in_School")
