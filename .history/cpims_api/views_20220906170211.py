...
class SchoolListViewSet(viewsets.ModelViewSet):
    ...
    authentication_classes = (TokenAuthentication,)
    queryset = SchoolList.objects.all()
    serializer_class = SchoolListSFacilityListSerializers
