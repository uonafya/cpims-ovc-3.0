...
router.register('reg_person_person_contact', views.RegPersonsOrgUnitsSerializer)
router.register('reg_person_person_contact', views.RegPersonsContactViewSet)
router.register('reg_person_person_external_ids', views.RegPersonsExternalIdsViewSet)
