...
class NotificationQuerySet(models.query.QuerySet):
    ...
    def unread(self, include_deleted=False):
        ...
        # When SOFT_DELETE=False, developers are supposed
        # NOT to touch 'deleted' field.
        # In this case, to improve query performance,
        # don't filter by 'deleted' field
...
class Notification(models.Model):
    ...
    level = models.CharField(choices=LEVELS, default=LEVELS.info,
                             max_length=20)
